...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Anjo\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=529191257596:+52 919 125 7596\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '*'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		if(antifake.includes(anu.jid)) {
			if (anu.action == 'add'){
				...
				if(!num.split('@')[0].startsWith(55)) {
					client.sendMessage(mdata.id, 'Proibido numero Fake', MessageType.text)
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `𝗦𝗔𝗟𝗩𝗘𝗘𝗘𝗘𝗘𝗘🌚🔥\n ◤◢ @${num.split('@')[0]} ◤◢\n𝘽𝙚𝙢 𝙫𝙞𝙣𝙙𝙤 𝙖𝙤 𝙜𝙧𝙪𝙥𝙤\n\n *${mdata.subject}* \n\n𝗣𝗼𝗿 𝗙𝗮𝘃𝗼𝗿 𝗟𝗲𝗶𝗮 𝗮𝘀 𝗥𝗲𝗴𝗿𝗮𝘀🐊\n 𝗘 𝗡𝗮𝗼 𝗘𝘀𝗾𝘂𝗲𝗰𝗲 𝗱𝗲 𝗨𝘀𝗮𝗿 𝗠𝗮𝘀𝗰𝗮𝗿𝗮😳🔥`
				...
				teks = `👋💩\n @${num.split('@')[0]} 𝗦𝗮𝗶𝘂 𝗣𝗼𝗿𝗾𝘂𝗲 𝗣𝗲𝗴𝗼𝘂 𝗖𝗢𝗩𝗜𝗗😣💉`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["0529191257596@s.whatsapp.net","552795195371@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"0529191257596@s.whatsapp.net","552795195371@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["0529191257596@s.whatsapp.net","552795195371@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["0529191257596@s.whatsapp.net","552795195371@s.whatsapp.net"]//ubah nomor lo
			const premium = ["0529191257596@s.whatsapp.net","552795195371@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`Link Detectado ${sender.split("@")[0]} Voce sera Removido(a) 👋Tchau`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 1000)
		setTimeout( () => {
	...
	if (messagesC.includes("corno")){
		...
		if (messagesC.includes("bot")){
			client.updatePresence(from, Presence.composing)
			reply("falou em bot? \nOlha eu aqui carai, o mais lindo e maravilhoso, \nperfeito desse mundo😜😎🤙")
	}
	
		if (messagesC.includes("chato")){
			client.updatePresence(from, Presence.composing)
			reply("Se nun Gostou VAZA FDP️")
	}
	
		if (messagesC.includes("linda")){
			client.updatePresence(from, Presence.composing)
			reply("Eiiiii, Para de mentir, iludir é feioo kkk🤭🤭️️")
	}
	
	if (messagesC.includes("up")){
			client.updatePresence(from, Presence.composing)
			reply("BAN️️")
	}
	
		if (messagesC.includes("bb")){
			client.updatePresence(from, Presence.composing)
			reply("o unico BB aq sou eu  kkkkj🙄️")
	}
	
		if (messagesC.includes("desculpa")){
			client.updatePresence(from, Presence.composing)
			reply("rlx ta desculpado, mas num faz dnv blz🤭️")
	}
	
		if (messagesC.includes("namoro")){
			client.updatePresence(from, Presence.composing)
			reply("seu gado🐂️")
	}
	
		if (messagesC.includes("amigos")){
			client.updatePresence(from, Presence.composing)
			reply("Ss, muito amigos🐊✨️")
	}	
	
	
		if (messagesC.includes("bora")){
			client.updatePresence(from, Presence.composing)
			reply("Sooh bora")
	}
	...
	if (messagesC.includes("sim")){
			client.updatePresence(from, Presence.composing)
			reply("Claro q sim karaiii😎")
	}


	    if (messagesC.includes("coitado")){
			client.updatePresence(from, Presence.composing)
			reply("odó meu deus do ceuuu kkkkkk")
	}
	
	
		if (messagesC.includes("beber")){
			client.updatePresence(from, Presence.composing)
			reply("trabalhar ninguém quer ne, agr beber🙄...️")
	}												
	
	
			if (messagesC.includes("bahc")){
			client.updatePresence(from, Presence.composing)
	...
	if (messagesC.includes("geme")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/geme.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
			...
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/gemido.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	...
	if (messagesC.includes("satanas")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/satanas.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	if (messagesC.includes("peidou")){
			client.updatePresence(from, Presence.composing)
	...
	if (messagesC.includes("nada")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/nada.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("vingadorarindo")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/vingadora.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("respeita")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/respeita.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
 if (messagesC.includes("chuvendo")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/chuvendo.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	if (messagesC.includes("chupa")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/chupa.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("maldade")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/maldade.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("ex")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/ex.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("galinha")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/galinha.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("travazap")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/travazap.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("rindoo")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/rindoo.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	...
	if (messagesC.includes("sera")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/sera.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			
	
	if (messagesC.includes("morreu")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/morreu.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	if (messagesC.includes("peida")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/peido.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("ainn")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/ain.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	...
	if (messagesC.includes("bicha")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/bicha.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	...
	if (messagesC.includes("burro")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/burro.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("cagao")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/cagao.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("pau")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/pau.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	...
	if (messagesC.includes("mesmo")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/mesmo.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			
	
	if (messagesC.includes("adoro")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/adoro.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	...
	if (messagesC.includes("mlk")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/mlk.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("piranha")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/piranha.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	...
	if (messagesC.includes("raspadinha")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/raspadinha.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	
	
	if (messagesC.includes("sefudeu")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/sefudeu.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	...
	if (messagesC.includes("viado")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/viado.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	...
	if (messagesC.includes("vsf")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/vsf.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	...
	if (messagesC.includes("wtf")){
			...
			client.updatePresence(from, Presence.composing)
			data = fs.readFileSync('./src/botjokes.js');
		...
		if (messagesC.includes("Alguem ai pra jogar?")){
			...
			switch(command) {
				...
				case 'help':
				case 'menu':
					buff = await getBuffer('https://i.ibb.co/XWGwStY/IMG-20210318-WA0478.jpg')
					client.sendMessage(from, buff, image, {caption: help(prefix), quoted: mek})
					break
				case 'help1':
				case 'menu1':
					buff = await getBuffer('https://i.ibb.co/XWGwStY/IMG-20210318-WA0478.jpg')
					client.sendMessage(from, buff, image, {caption: help1(prefix), quoted: mek})
					break
					case 'kiss':
				    try {    
    ...
    break
			...
			case 'google':
                ...
                case 'slogo':
					...
					buffer = await getBuffer(`https://budenter.sirv.com/Images/slogo.jpg?text.0.text=${teks}&text.0.position.gravity=center&text.0.position.y=40%25&text.0.size=43&text.0.color=ffffff&text.0.font.family=Varela%20Round&text.0.font.style=italic&text.0.background.opacity=1&text.0.outline.blur=53`)
                ...
                case 'plogo':
					...
					if (teks.length > 15) return reply('*O texto é longo*')
					reply('*Aguarde...*')
					Daddy = await getDaddy(`https://budenter.sirv.com/Images/plogo.jpg?text.0.text=${teks}&text.0.position.gravity=northwest&text.0.position.x=34%25&text.0.position.y=24%25&text.0.size=1&text.0.color=000000&text.0.font.family=Paytone%20One`)
					client.sendMessage(from, Daddy, image, {quoted: mek, caption: '*toma aqui seu lixo*'})
					break
				       case 'musica':
                reply(mess.wait)
                play = body.slice(5)
...
break
				...
				break 
					...
					if (Number(args[0]) === 1) {
						...
						client.sendMessage(from,`Ativei a Porra do Ant-Link nesse Krl😎🔥`, text)
					} else if (Number(args[0]) === 0) {
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS ANJO BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @Anjo domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o Anjo ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT ANJO ✨* 」\n*│+ wa.me/0529191257596*╰──────*「 *ANJO* 」*────*\n\n*_SE QUER SER ADMIN DO BOT ANJO_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/554792091566/*╰──────*「 * ANJO* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO ANJO BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
